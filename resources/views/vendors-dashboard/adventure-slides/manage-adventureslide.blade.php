                            ...
                            <table class="table table-editable table-nowrap align-middle table-edits">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="1">
                                        ...
                                        <td data-field="name">{{$slide->place_name}}</td>
                                       
                                        @php
                                        $images = json_decode($slide->image);
                                       
                                        @endphp
                                        <td data-field="slide">
                                        
                                        <img src="{{$slide->image}}" id="images" width="100px" height="100px" alt="" class="popupimage">
                                       
                                    </td>
                                         
                                        <td style="width: 100px">
                                        <form action="{{ route('slideadventure.destroy',$slide->id) }}" method="Post">
                                        
                                        <a class="btn btn-outline-secondary btn-sm edit" href="{{ route('slideadventure.edit',$slide->id) }}">
