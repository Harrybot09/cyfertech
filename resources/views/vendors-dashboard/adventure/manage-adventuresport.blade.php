    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <a href="{{route('sportsadventure.create')}}"> <button type="button" class="btn btn-outline-blue-grey waves-effect waves-light" style=" right:45px; float:right; position:absolute" >Add Adventure</button></a>
                            ...
                            <table class="table table-editable table-nowrap align-middle table-edits">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="1">
                                        ...
                                        <form action="{{route('sportsadventure.destroy',$data->id)}}" method="Post">
                                        
                                        <a class="btn btn-outline-secondary btn-sm edit" href="{{route('sportsadventure.edit',$data->id)}}">
